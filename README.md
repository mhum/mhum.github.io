...
5. Run Jekyll and watch files by running `bundle exec npx gulp`
...
While running `bundle exec npx gulp` modify any of the files in the `assets/scss/` folder and your browser will update automatically. No reload required!
